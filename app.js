...
(function () {
  ...
  function getGrowthWeeklyBudget() { return getWeeklyBudget() * GROWTH_PCT; }
  function getMaintWeeklyBudget() { return getWeeklyBudget() * MAINT_PCT; }
  function getGrowthMonthlyBudget() { return getMonthlyBudget() * GROWTH_PCT; }
  function getMaintMonthlyBudget() { return getMonthlyBudget() * MAINT_PCT; }
  ...
  function exportCSV() {
    ...
    var monthYear = MONTH_NAMES[now.getMonth()] + " " + now.getFullYear();
    var targets = getPipelineTargets();
    var csvRows = [];
    ...
    csvRows.push([
      ...
      "Growth (20%): " + formatCurrency(state.quarterlyBudget * GROWTH_PCT),
      "Maint (80%): " + formatCurrency(state.quarterlyBudget * MAINT_PCT)
    ]);
    csvRows.push([]);
    ...
    // Monthly summaries for each month in quarter
